...
pages = {
    ...
    'Daphne_HERAN': {
        ...
        'Nom': "HERAN",
        'Etablissement': 'INRAE',
        'Description': _("Chargée de recherche optique"),
        'Domaine_de_recherche': _("Optique, Chimiométrie"),
        'Google_Scholar': '',
        'Linkedin': '',
        'Biographie': "",
    ...
    'Jean_Michel_ROGER': {
        ...
        'Nom': "ROGER",
        'Etablissement': 'INRAE',
        'Description': _("Ingénieur du génie rural pour l'environnement et l'agriculture"),
        'Domaine_de_recherche': _("Chimiométrie, Spectroscopie"),
    ...
    'Florent_ABDELGHAFOUR': {
        ...
        'Etablissement': 'INRAE',
        'Description': '',
        'Domaine_de_recherche': _("Chimiométrie, Intelligence Artificielle"),
        'Google_Scholar': '',
        'Linkedin': '',
        'Biographie': "",
        'Publications': [],
    ...
    'Nicolas_EMANUELY': {
        ...
        'Nom': "EMANUELY",
        'Etablissement': 'PST',
        'Description': _("Ingénieur optique et traitement d'image"),
        'Domaine_de_recherche': _("Optique, Intelligence artificielle"),
        'Google_Scholar': '',
        'Linkedin': 'https://www.linkedin.com/in/nicolas-emanuely-6947b3129/',
        'Biographie': _("Diplomé d'un double diplome Supoptique-ESPCI, Nicolas a démarré en tant qu'ingénieur d'application dans le domaine de l'imagerie médicale. Il poursuit sa carriere au sein de Pellenc ST en tant qu'ingénieur optique et traitement d'image."),
    ...
    'Gwenaele_LECORRE': {
        ...
        'Nom': "LE CORRE",
        'Etablissement': 'PST',
        'Description': _("Ingénieure optique et chef de projet"),
        'Domaine_de_recherche': _('Optique'),
        'Google_Scholar': '',
    ...
    'Ivy_TUMOINE': {
        ...
        'Nom': "TUMOINE",
        'Etablissement': 'PST',
        'Description': _("Doctorant"),
        'Domaine_de_recherche': _("Intelligence artificielle, Chimiométrie"),
        'Google_Scholar': '',
...
def chercheurs(request, lang):
    context = {"chercheurs": pages, "active_page": "chercheurs", "LANGUAGE_CODE": lang}
    return render(request, "pages/chercheurs.html", context)

def get_chercheurs_pages():
    langs = ['fr', 'en']
    for lang in langs:
        for name in pages.keys():
            yield {'lang': lang, 'chercheur_name': name}


def chercheurs_page(request, lang, chercheur_name):
    if chercheur_name.endswith('.html'):
        chercheur_name = chercheur_name[:-5]

    context = pages.get(chercheur_name, {}).copy()
    ...
    _ = translator.gettext  # local uniquement

    for key in ['Description', 'Domaine_de_recherche', 'Biographie']:
        if context.get(key):
            context[key] = _(context[key])
...
def partenaires(request, lang):
    return render(request, "pages/partenaires.html", {"active_page": "partenaires", "LANGUAGE_CODE": lang})

def contact(request, lang):
    return render(request, "pages/contact.html", {"active_page": "contact", "LANGUAGE_CODE": lang})
